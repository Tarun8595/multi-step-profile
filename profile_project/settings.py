...
DATABASES = {
    ...
    'mongo': {
        ...
        'NAME': 'profile_db',
        'CLIENT': {
            'host': 'mongodb+srv://tarun_work:7CQWktCOWHAmNrOr@cluster0.t7roydh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',  # Update with your MongoDB Atlas connection string
        }
    }
}
